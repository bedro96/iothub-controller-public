...
import { Activity, Database, Users, FileText } from "lucide-react"
...
export default function MonitoringPage() {
  ...
  const fetchData = async () => {
    try {
      ...
      await ensureCsrf()
      const statsResponse = await fetchWithCsrf("/api/server-logs", {
        method: "POST",
      ...
      // Fetch logs
      const logsResponse = await fetch(`/api/server-logs?type=${logType}&lines=50`, {
        credentials: "include",
      })
  ...
  return (
    <div className="min-h-screen bg-background">
      <AdminNav title="System Logs" onRefresh={fetchData} />
      <div className="max-w-7xl mx-auto p-8">
        ...
        {stats && (
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium">Total Devices(mapping-table)</CardTitle>
